    ...
    <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p>
            Hello, I&apos;m an undergraduate at University of Science, Vietnam
            National University Ho Chi Minh City. Studying in Information and
            Technology - Class of 2028, looking forward to major in Artificial
            Intelligence in Junior year.
          </p>
