  ...
  return (
    <div id='top' className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
          Hi! I&apos;m Minh Dang <Image src={assets.hand_icon} alt='' className='w-6'/>
      </h3>
      <h1 className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
        Information and Technology sophomore in Ho Chi Minh City
      </h1> 
      <p className='max-w-2xl mx-auto font-Ovo'>
          I am an IT sophomore, AI and Machine Learning enthusiast at University of Science, VNU-HCM.
      </p>
